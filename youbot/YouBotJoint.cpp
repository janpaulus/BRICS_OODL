...
void YouBotJoint::setData(const JointSensorAngle& data, SyncMode communicationMode) {
  // Bouml preserved body begin 0003C1F1
  // Bouml preserved body end 0003C1F1
}

void YouBotJoint::setData(const JointSensorVelocity& data, SyncMode communicationMode) {
